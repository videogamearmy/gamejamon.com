...
global $avia_config;
	 ...
	 */	
	 ...
	 {
		the_post();
		$content_true = "without-post-content";
		if(get_the_content() != "") $content_true = "with-post-content";
	 }
	...
	?>
		...
		<div class='container_wrap main_color <?php avia_layout_class( 'main' ); ?> <?php avia_is_dark_bg('main_color'); ?>'>
			...
			<div class='container padding-container portfolio-default-container container-portfolio-size-<?php echo $avia_config['portfolio']['portfolio_columns']; ?>'>
				
				<div class='content <?php avia_layout_class( 'content' ); ?> units template-portfolio-overview content portfolio-size-<?php echo $avia_config['portfolio']['portfolio_columns']; echo " ".$content_true; ?>'>
