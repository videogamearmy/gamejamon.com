...
global $avia_config;
	...
	?>
		...
		<div class='container_wrap main_color <?php avia_layout_class( 'main' ); ?> <?php avia_is_dark_bg('main_color'); ?>'>
			...
			<div class='container portfolio-default-container container-portfolio-size-<?php echo $avia_config['portfolio']['portfolio_columns']; ?>'>
				
				<div class='content hidden-block <?php avia_layout_class( 'content' ); ?> units template-portfolio-overview content portfolio-size-<?php echo $avia_config['portfolio']['portfolio_columns'];  ?>'>
