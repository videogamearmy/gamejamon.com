...
{
	$output  = "";
	$output .= "<h1 class='post-title ". avia_offset_class('meta', false). "'>";
...
function avia_link_content_filter($current_post)
{
	...
	{
		$link = $link[0];
		$current_post['title'] = "<a href='$link' rel='bookmark' title='".__('Link to: ','avia_framework').get_the_title()."' >".get_the_title()."</a>";
