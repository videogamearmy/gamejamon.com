...
$boxes = array( 
	...
	//array( 'title' =>  'Additional Options', 'id'=>'add_options' , 'page'=>array('post','page','portfolio'), 'context'=>'normal', 'priority'=>'high' ),
	 array( 'title' =>  'Portfolio Layout', 'id'=>'portfolio-layout' , 'page'=>array('portfolio'), 'context'=>'side', 'priority'=>'low' )
...
array(	
	...
	array(	
					"slug"	=> "portfolio-layout",
					"name" 	=> "Portfolio Layout",
					"desc" 	=> "Choose a portfolio layout</a>",
					"id" 	=> "portfolio-layout",
					"type" 	=> "select",
					"std" 	=> "portfolio_right",
					"hook" 	=> 'on_save_layout_dynamic_save',
					"no_first"=>true,
					"subtype" => array( 
											'Text right to small Image'=>'portfolio_right',
											'Text bellow Fullsize Image'=>'portfolio_fullsize'
