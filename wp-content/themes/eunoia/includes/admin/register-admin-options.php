...
$avia_elements[] =	array(	
					"slug"	=> "avia",
					"std"	=> "Support Hotline: (555) 343 456 7891",
					"name" 	=> "Header textarea above Social media icons",
					"desc" 	=> "Phone number or small note, displayed above the social icon and search bar",
					"id" 	=> "small_header",
					"type" 	=> "text"
					);
...
$avia_elements[] =	array(	
					...
					"desc" 	=> "A Message that can promote important events. It is displayed to each user. As soon as the user closes the message it will no longer appear for him/her until you enter a new message.",
					"id" 	=> "banner",
					"std"	=> "Welcome to the Choices WordPress Theme - a theme that allows you to build unique skins in no time...",
					"type" 	=> "textarea"
					);
*/
...
$avia_elements[] =	array(	
					...
					<style type='text/css'>
						...
						#stretched .live_bg_wrap{padding:0; border:none;}
					...
					<div id='avia_preview' class='live_bg_wrap webfont_default_font'>
						...
						<div class='live-header_color live-main_color border'>
...
$avia_elements[] =	array(	"name" 	=> "Heading Font",
				            ...
				            "subtype" => array(	'no custom font'=>'',
				            					...
				            					'Yanone Kaffesatz'=>'Yanone Kaffeesatz:200',
...
foreach($colorsets as $set_key => $set_value)
{
	...
	$avia_elements[] = array(	"slug"	=> "styling", "type" => "hr", "id" => "hr1".$set_value, "nodescription" => true);				
...
$avia_elements[] =	array(	
	...
	//$avia_elements[] = array(	"slug"	=> "styling", "type" => "hr", "id" => "hr2".$set_value, "nodescription" => true);				
...
$avia_elements[] =	array(	
				...
				'subelements' 	=> array(	
						...
						array(	
								...
								"desc" 	=> "How many columns should be displayed? Should a sidebar be displayed as well?<br/>",
						...
						array(	
								...
								"desc" 	=> "Should the sorting options based on categories be displayed?<br/>",
						...
						array(	
								...
								"desc" 	=> "Should a portfolio pagination be displayed?<br/><br/>",
						...
						array(	
								"slug"	=> "portfolio",
								"name" 	=> "Portfolio Greyscale Overlay?",
								"desc" 	=> "Should a greyscale hover effect be applied?<br/><br/>",
								"id" 	=> "portfolio_greyscale",
								"type" 	=> "select",
								"std" 	=> "yes",
								"no_first"=>true,
								"class" => "av_2columns av_col_2",
