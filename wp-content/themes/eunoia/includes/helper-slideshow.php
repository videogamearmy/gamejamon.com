...
class avia_slideshow
{
	...
	*/
	...
	function set_caption($caption = false)
	{
	...
	function slideshow()
	{
		...
		{ 
			...
			if( strpos($this->position, 'thumb') !== false && !avia_is_overview()) $output .=  $this->slideshow_thumbs();
	...
	function slideshow_thumbs()
	{
		...
		{ 
			$output .= "</div></div></div>  <div class='thumbnails_container_wrap container_wrap main_color'><div class='container'>";
