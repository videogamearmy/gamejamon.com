...
class LoginWithAjaxAdmin{
	...
	function admin_notices() {
		...
		<div id='lwa-warning' class='updated fade'>
			<p>
				<?php _e('New features in Login With AJAX (including registration!), check out the settings and widget pages!', MAHA_TEXT_DOMAIN) ?> - 
				<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=login-with-ajax"><?php _e('Settings', MAHA_TEXT_DOMAIN); ?></a> | 
				<a href="<?php echo $dismiss ?>"><?php _e('Dismiss', MAHA_TEXT_DOMAIN) ?></a> 
			</p>
		</div>
		<?php
	}
	...
	function options() {
		...
		if( !empty($_POST['lwasubmitted']) && current_user_can('list_users') && wp_verify_nonce($_POST['_nonce'], 'login-with-ajax-admin'.get_current_user_id()) ){
			...
			?>
			<div class="updated"><p><strong><?php _e('Changes saved.', MAHA_TEXT_DOMAIN); ?></strong></p></div>
			<?php
		}else{
			...
			<div id="poststuff" class="metabox-holder has-right-sidebar">
				...
				<div id="post-body">
					<div id="post-body-content">
						...
						<h2><?php _e("General Settings", MAHA_TEXT_DOMAIN); ?></h2>
						<table class="form-table">
							<?php if( count(LoginWithAjax::$templates) > 1 ) : ?>
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Default Template", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									...
									<br />
									<em><?php _e("Choose the default theme you'd like to use. This can be overriden in the widget, shortcode and template tags.", MAHA_TEXT_DOMAIN); ?></em>
									<em><?php _e("Further documentation for this feature coming soon...", MAHA_TEXT_DOMAIN); ?></em>
								</td>
							</tr>
							<?php endif; ?>
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Disable refresh upon login?", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									...
									<br />
									<em><?php _e("If the user logs in and you check the button above, only the login widget will update itself without refreshing the page. Not a good idea if your site shows different content to users once logged in, as a refresh would be needed.", MAHA_TEXT_DOMAIN); ?></em>
								</td>
							</tr>
						</table>
						
						
						<h2><?php _e("Redirection Settings", MAHA_TEXT_DOMAIN); ?></h2>
						<table class="form-table">
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Global Login Redirect", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									<input type="text" name="lwa_login_redirect" value='<?php echo (!empty($lwa_data['login_redirect'])) ? $lwa_data['login_redirect']:''; ?>' class='wide' />
									<em><?php _e("If you'd like to send the user to a specific URL after login, enter it here (e.g. http://wordpress.org/)", MAHA_TEXT_DOMAIN); ?></em>
									<br/><em><?php _e("Use %USERNAME% and it will be replaced with the username of person logging in.", MAHA_TEXT_DOMAIN); ?></em>
									<?php
									//WMPL itegrations
							...
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Global Logout Redirect", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									...
									<em><?php _e("If you'd like to send the user to a specific URL after logout, enter it here (e.g. http://wordpress.org/)", MAHA_TEXT_DOMAIN); ?></em>
									<br /><em><?php _e("Enter %LASTURL% to send the user back to the page they were previously on.", MAHA_TEXT_DOMAIN); ?></em>
									<?php 
							...
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Role-Based Custom Login Redirects", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									<em><?php _e("If you would like a specific user role to be redirected to a custom URL upon login, place it here (blank value will default to the global redirect)", MAHA_TEXT_DOMAIN); ?></em>
									<table>
									<?php 
							...
							<tr valign="top">
								<td scope="row">
									<label><?php _e("Role-Based Custom Logout Redirects", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									<em><?php _e("If you would like a specific user role to be redirected to a custom URL upon logout, place it here (blank value will default to the global redirect)", MAHA_TEXT_DOMAIN); ?></em>
									<table>
									<?php 
									//Taken from /wp-admin/includes/template.php Line 2715  
									$editable_roles = get_editable_roles();		
						...
						<h2><?php _e("Notification Settings", MAHA_TEXT_DOMAIN); ?></h2>
						<p>
							<em><?php _e("If you'd like to override the default Wordpress email users receive once registered, make sure you check the box below and enter a new email subject and message.", MAHA_TEXT_DOMAIN); ?></em><br />
							<em><?php _e("If this feature doesn't work, please make sure that you don't have another plugin installed which also manages user registrations (e.g. BuddyPress and MU).", MAHA_TEXT_DOMAIN); ?></em>										
						</p>
						<table class="form-table">
							<tr valign="top">
								<td>
									<label><?php _e("Override Default Email?", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
							...
							<tr valign="top">
								<td>
									<label><?php _e("Subject", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									<?php 
									if(empty($lwa_data['notification_subject'])){
										$lwa_data['notification_subject'] = __('Your registration at %BLOGNAME%', MAHA_TEXT_DOMAIN);
									}
									?>
									...
									<em><?php _e("<code>%USERNAME%</code> will be replaced with a username.", MAHA_TEXT_DOMAIN); ?></em><br />
									<em><?php _e("<code>%PASSWORD%</code> will be replaced with the user's password.", MAHA_TEXT_DOMAIN); ?></em><br />
									<em><?php _e("<code>%BLOGNAME%</code> will be replaced with the name of your blog.", MAHA_TEXT_DOMAIN); ?></em>
									<em><?php _e("<code>%BLOGURL%</code> will be replaced with the url of your blog.", MAHA_TEXT_DOMAIN); ?></em>
								</td>
							</tr>
							<tr valign="top">
								<td>
									<label><?php _e("Message", MAHA_TEXT_DOMAIN); ?></label>
								</td>
								<td>
									<?php 
...
The team at %BLOGNAME%', MAHA_TEXT_DOMAIN);
										}
										?>
