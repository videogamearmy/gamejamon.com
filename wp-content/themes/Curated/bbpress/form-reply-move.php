...
<div id="bbpress-forums">
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move">
			...
			<form id="move_reply" class="maha-bbp-form" name="move_reply" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<fieldset class="bbp-form bbp-margin-top">
							<legend class="bbp-section-caption"><?php _e( 'Move Method', 'bbpress' ); ?></legend>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit" name="bbp_move_reply_submit" class="button submit mh-button"><?php _e( 'Submit', 'bbpress' ); ?></button>
						</div>
					</div>
