...
<div class="row">
	...
	<div class="col-sm-12">
		<div class="cover-wrap">
			...
			<div class="cover" style="background-image: url(<?php echo maha_featured_url( $post->ID , 'mh_large'); ?>);">
					...
					<div class="row">
						...
						<div class="col-sm-8" <?php echo $itemscope; ?>>
							...
							<div class="meta-info">
								...
								<span class="meta-info-comments"><i class="icon-comment"></i><a href="<?php the_permalink(); ?>#comments"><?php comments_number('0 ', '1 ', '% '); ?></a></span>
								<?php } ?>
								<?php if ( $maha_options['single_commentr'] == true ) {
