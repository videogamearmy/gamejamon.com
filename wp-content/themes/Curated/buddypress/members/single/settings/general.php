...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<input type="password" name="pass1" id="pass1" size="16" value="" class="settings-input small" /> <div class="pass-title"><?php _e( 'New Password', 'buddypress' ); ?></div>
	<input type="password" name="pass2" id="pass2" size="16" value="" class="settings-input small" /> <div class="pass-title"><?php _e( 'Repeat New Password', 'buddypress' ); ?></div>
